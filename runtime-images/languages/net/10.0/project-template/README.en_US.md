# .NET 10.0 Runtime Template

This template provides a minimal ASP.NET Core service for DevBox runtime **.NET 10.0**.

## Runtime Summary

- Language/runtime version: `.NET 10.0`
- Base runtime image: `net-10.0`
...
- Runs published app: `dotnet ./bin/Release/net10.0/publish/hello_world.dll`

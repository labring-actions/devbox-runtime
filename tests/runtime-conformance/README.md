...
| `frameworks/sandbox/v1` | workspace ownership, codex-gateway, Codex CLI, Node/npm, Python/pip, kubectl, helm, gh, bun, ripgrep, bubblewrap, Railpack CLI, VersityGW POSIX S3 context service, npm/pip mirrors for `zh_CN` |

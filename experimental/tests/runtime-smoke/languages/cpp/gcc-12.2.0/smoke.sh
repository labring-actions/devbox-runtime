...
g++ --version | grep -q '12.2.0'

if [ ! -f "$project_dir/hello_world.cpp" ]; then
  echo "Missing hello_world.cpp in $project_dir" >&2
  exit 1
fi

g++ -c "$project_dir/hello_world.cpp" -o /tmp/hello_world.o

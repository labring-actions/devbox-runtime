...
gcc --version | grep -q '12.2.0'

if [ ! -f "$project_dir/hello_world.c" ]; then
  echo "Missing hello_world.c in $project_dir" >&2
  exit 1
fi

gcc -c "$project_dir/hello_world.c" -o /tmp/hello_world.o
